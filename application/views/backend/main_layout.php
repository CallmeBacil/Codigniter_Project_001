...
<head>
  ...
  <?php
  // Memberikan fallback string kosong jika get_user_data mengembalikan null
  $date = date('d-m-Y', strtotime(get_user_data('last_activity') ?? ''));
  function format_hari_tanggal($waktu)
  {
    // Jika waktu kosong atau null, langsung return strip saja
    if (empty($waktu) || $waktu == '01-01-1970' || $waktu == '1970-01-01') {
        return "-";
    }
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <div class="copyright text-center my-auto">
	    <span>Copyright &copy; 2022 - <?= date('Y'); ?> <a href="https://yuuki0.net" target="_blank">Baron Wahyu Gumelar</a>. All Rights Reserved</span>
    </div>
