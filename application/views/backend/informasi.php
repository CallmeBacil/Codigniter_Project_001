        ...
        <div class="box box-info">
          <div class="box-header with-border">
            ...
            <h5 class="text-center">
              Copyright &copy; <?= date('Y'); ?> <a href="https://yuuki0.net" target="_blank">Baron Wahyu Gumelar</a>
            </h5>
            <h5>
      ...
      <div class="col-md-12">
        <div class="box box-widget widget-user-2">
            <div class="widget-user-header bg-blue">
                <div class="widget-user-image">
                    <img alt="Support to Baron Wahyu Gumelar" src="<?=BASE_ASSET;?>/img/support.png">
                    </img>
                </div>
                ...
                <h5 class="widget-user-desc">
                  Dukungan Anda sangat berarti bagi <a href="https://github.com/yuukiofuyu" target="_blank">Baron Wahyu Gumelar</a> untuk terus mengembangkan proyek aplikasi maupun program sumber terbuka di masa mendatang.
                </h5>
            </div>
            <div class="widget-user-header bg-white">
              <div class="text-center">
                  <button type="button" class="btn btn-primary btn-lg donate-button" id="donasiBtn">💝 Dukung Baron Wahyu Gumelar</button>
              </div>
            </div>
        </div>
        <!-- /.row -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
              ...
              <h4 class="modal-title" id="donasiModalLabel">Form Dukungan untuk Baron Wahyu Gumelar</h4>
            </div>
